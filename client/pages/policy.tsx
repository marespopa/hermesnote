      ...
      <Layout>
        <section className="py-4 px-4 md:px-0 md:py-8">
          ...
          <p className={paragraphStyle}>
            ...
            which can be accessed at marespopa.com “Service” refers to the
            Company’s services accessed via the Site, in which users can send an
            email in order to obtain a quote. The terms “we,” “us,” and “our”
            refer to the Company. “You” refers to you, as a user of our Site or
            our Service. By accessing our Site or our Service, you accept our
            Privacy Policy and Terms of Use (found here:
            https://marespopa.com/privacy-policy), and you consent to our
            collection, storage, use and disclosure of your Personal Information
            as described in this Privacy Policy.
          </p>
          <h2 className={headingStyle}>I. INFORMATION WE COLLECT</h2>
          <p className={paragraphStyle}>
            ...
            Personal Information includes your IP Address and your email
            address. 1. Information collected via Technology To activate the
            Service you do not need to submit any Personal Information other
            than your email address. To use the Service thereafter, yo do not
            need to submit further Personal Information which may include: IP
            Address, email address]. However, in an effort to improve the
            quality of the Service, we track information provided to us by your
            browser or by our software application when you view or use the
            ...
            cookies to collect the following information: IP Address Location
            ...
            your browser. 3. Children’s Privacy The Site and the Service are not
            directed to anyone under the age of 13. The Site does not knowingly
            collect or solicit information from anyone under the age of 13, or
            allow anyone under the age of 13 to sign up for the Service. In the
            event that we learn that we have gathered personal information from
            anyone under the age of 13 without the consent of a parent or
            guardian, we will delete that information as soon as possible. If
            you believe we have collected such information, please contact us at
            contact@marespopa.com
          </p>
          <h2 className={headingStyle}>II. HOW WE USE AND SHARE INFORMATION</h2>
          <p className={paragraphStyle}>
            ...
            performing services for the Company, such as the servers for our
            email communications who are provided access to user’s email address
            ...
            our Privacy Policy. In general, the Personal Information you provide
            to us is used to help us communicate with you. For example, we use
            Personal Information to contact users in response to questions,
            solicit feedback from users, provide technical support, and inform
            users about promotional offers. We may share Personal Information
            with outside parties if we have a good-faith belief that access,
            ...
            or permitted by law. Non-Personal Information: In general, we use
            Non-Personal Information to help us improve the Service and
            ...
            Site. This Privacy Policy does not limit in any way our use or
            disclosure of Non-Personal Information and we reserve the right to
            use and disclose such Non-Personal Information to our partners,
            advertisers and other third parties at our discretion. In the event
            we undergo a business transaction such as a merger, acquisition by
            ...
            forth in this Privacy Policy. If our information practices change at
            any time in the future, we will post the policy changes to the Site
            so that you may opt out of the new information practices. We suggest
            that you check the Site periodically if you are concerned about how
            your information is used.
          </p>
          <h2 className={headingStyle}> III. HOW WE PROTECT INFORMATION</h2>
          <p className={paragraphStyle}>
          ...
          <h2 className={headingStyle}> IV. LINKS TO OTHER WEBSITES</h2>
          <p className={paragraphStyle}>
          ...
          <h2 className={headingStyle}>V. CHANGES TO OUR PRIVACY POLICY</h2>
          <p className={paragraphStyle}>
            ...
            effect immediately. You should periodically check the Site and this
            privacy page for updates.
          </p>
          <h2 className={headingStyle}>VI. CONTACT US</h2>
          <p className={paragraphStyle}>
...
const mainHeadingStyle = "text-5xl mb-5";
const headingStyle = "text-2xl mt-5";
const paragraphStyle = "mt-2";
