  ...
  return (
    <TextDocument>
      ...
      <p>
        ...
        (found here: https://hermesmd.netlify.app/privacy-policy), and you
      ...
      <p>
        ...
        Information includes your IP Address and your email address. 1.
        Information collected via Technology To activate the Service you do not
        need to submit any Personal Information other than your email address.
        To use the Service thereafter, yo do not need to submit further Personal
        Information which may include: IP Address, email address]. However, in
        an effort to improve the quality of the Service, we track information
        ...
        information: IP Address Location The Company may use both persistent and
        ...
        expire when you close your browser. 3. Children’s Privacy The Site and
        the Service are not directed to anyone under the age of 13. The Site
        does not knowingly collect or solicit information from anyone under the
        age of 13, or allow anyone under the age of 13 to sign up for the
      ...
      <p>
        Personal Information: Except as otherwise stated in this Privacy Policy,
        we do not sell, trade, rent or otherwise share for marketing purposes
        your Personal Information with third parties without your consent. We do
        share Personal Information with vendors who are performing services for
        the Company, such as the servers for our email communications who are
        ...
        Personal Information with outside parties if we have a good-faith belief
        that access, use, preservation or disclosure of the information is
        reasonably necessary to meet any applicable legal process or enforceable
        ...
        Non-Personal Information: In general, we use Non-Personal Information to
        help us improve the Service and customize the user experience. We also
        aggregate Non-Personal Information in order to track trends and analyze
        use patterns on the Site. This Privacy Policy does not limit in any way
