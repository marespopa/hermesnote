    ...
    <div className="w-full max-w-screen-xl mx-auto my-4 md:my-8">
      <section className="prose dark:prose-invert">
        ...
        <p>
          ...
          https://hermesmd.netlify.app/privacy-policy), and you consent to our
        ...
        <p>
          ...
          Information collected via Technology To activate the Service you do
          not need to submit any Personal Information other than your email
          address. To use the Service thereafter, yo do not need to submit
          further Personal Information which may include: IP Address, email
          address]. However, in an effort to improve the quality of the Service,
          we track information provided to us by your browser or by our software
          ...
          collect the following information: IP Address Location The Company may
          ...
          while session cookies expire when you close your browser. 3.
          Children’s Privacy The Site and the Service are not directed to anyone
          under the age of 13. The Site does not knowingly collect or solicit
          information from anyone under the age of 13, or allow anyone under the
          age of 13 to sign up for the Service. In the event that we learn that
          we have gathered personal information from anyone under the age of 13
          without the consent of a parent or guardian, we will delete that
          information as soon as possible. If you believe we have collected such
          information, please contact us at contact@marespopa.com
        </p>
        ...
        <p>
          ...
          users or the public as required or permitted by law. Non-Personal
          Information: In general, we use Non-Personal Information to help us
          improve the Service and customize the user experience. We also
          aggregate Non-Personal Information in order to track trends and
          analyze use patterns on the Site. This Privacy Policy does not limit
          in any way our use or disclosure of Non-Personal Information and we
          reserve the right to use and disclose such Non-Personal Information to
          our partners, advertisers and other third parties at our discretion.
