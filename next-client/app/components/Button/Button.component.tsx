...
const variantStyles = (variant: ButtonVariant) => {
  ...
  const primaryStyles = `${baseStyles} bg-teal-500 hover:bg-teal-600 focus:bg-teal-600 ${disabledStyles}`;
  const defaultStyles = `${baseStyles} bg-gray-900 hover:bg-teal-800 focus:bg-gray-800
