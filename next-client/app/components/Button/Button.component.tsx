...
const variantStyles = (variant: ButtonVariant) => {
  ...
  const primaryStyles = `${baseStyles} bg-emerald-800 hover:bg-emerald-900 focus:bg-emerald-900 ${disabledStyles} dark:bg-emerald-600 dark:hover:bg-emerald-700 dark:focus:bg-emerald-700`;
  ...
  const smallVariants = {
    ...
    success: `bg-emerald-800 hover:bg-emerald-900 focus:bg-emerald-900 dark:bg-emerald-600 dark:hover:bg-emerald-700 dark:focus:bg-emerald-700`,
