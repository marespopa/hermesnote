    ...
    <div className="w-full max-w-screen-xl px-4 md:px-2 mx-auto my-4 md:my-8">
      <section className="prose dark:prose-invert">
        ...
        <p>
          ...
          www.hermesmd.netlify.app and any related website owned or operated
        ...
        <p>
          The Hermes Markdown platform is an online file editor tool, that allows
          you to easily create, import, edit, with the aim to build a culture of
          transparency, ownership and accountability, inclusive of any and all
          functionalities, application programming interface and tools offered
          as part of Hermes Markdown platform, offered online (the “Service”).
          Specific Terms may apply to You or to some of the Service, such
          specific terms are incorporated herein by reference and form an
          integral part hereof. export markdown filescloud-based visual work
        ...
        <p>
          ...
          you by posting an announcement on the Sites and/or via the Servic e or
        ...
        <p>
          ...
          Services, or dependent on any public comments we make, orally or in
        ...
        <p>
          ...
          are only intended for individuals aged sixteen (16) years or older. We
        ...
        <h2>2. Liability</h2>
        <p>
          Hermes Markdown BEARS NO RESPONSIBILITY AND/OR LIABILITY FOR ANY LINKS OR
          ...
          ACCURACY, RELIABILITY, DATA PROTECTION AND PROCESSING PRACTICES AND
          THE QUALITY OF ITS OFFERINGS, AS WELL AS ANY ACTS OR OMMISSIONS BY
          THIRD PARTIES. BY ACCESSING AND/OR USING THE THIRD PARTY SERVICES, YOU
          ACKNOWLEDGE THAT YOUR ACCESS AND USE OF THE THIRD PARTY SERVICES ARE
          AT YOUR SOLE DISCRETION AND RISK, AND YOU ARE SOLELY RESPONSIBLE FOR
